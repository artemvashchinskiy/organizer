...
export default function LicenseCenter({
    ...
    // A valid license overrides the end of
    // the initial trial. Only an expired
    // license or an expired trial without
    // a license blocks the application.
    const locked =
        expired ||
        ...
        >
            ...
            <div className="license-content">
                ...
                <div className="license-note">
                    ...
                    complimentary license is a simple
                    product activation and recognition
                    mechanism — there is no purchase
                    required.
                </div>
            </div>
        </div>
