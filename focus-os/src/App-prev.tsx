...
import { addActivity } from "./services/activityServiceLog"; 
import {
...
import useDropboxBackup from
    "./hooks/useDropboxBackup";
import useGoogleDriveBackup from
    "./hooks/useGoogleDriveBackup";
...
function App(){
    ...
    const oneDriveCallbackHandled = useRef(false);
...
useEffect(() => {
    if (oneDriveCallbackHandled.current) {
        return;
    }

    if (!isOneDriveAuthCallback()) {
        return;
    }

    oneDriveCallbackHandled.current = true;
